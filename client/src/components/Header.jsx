...
function Header () {
    ...
    return (
        <>  
    <header className=" bg-opacity-100">
    ...
    <div className="flex lg:hidden">
      <button onClick={closeNavHandler} type="button" className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
    ...
    <div className="hidden lg:flex lg:gap-x-12">
      <div className="relative">
        ...
        type="button" 
        className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false">
          Product
        ...
        {navToggle && <div onClick={closeNavHandler} className=" transition ease-out duration-200 absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
          <div className="p-4">
            <div className="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
              ...
              { currentUser?.id ? <Link to={`/profile/${currentUser.id}`} className="block font-semibold text-gray-900">
                  Account
            ...
            <div className="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
              ...
              <div className="flex-auto">
                <Link to='/authors' className="block font-semibold text-gray-900">
                  Authors
                  <span className="absolute inset-0"></span>
                </Link>
                <p className="mt-1 text-gray-600">See and Seek all the authors&apos; posts</p>
              </div>
            </div>
            <div className="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
              <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
          ...
          <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
            <Link to="/create-post" className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-100">
              <svg className="h-5 w-5 flex-none text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    {currentUser? <a href="/logout" className="text-sm font-semibold leading-6 text-gray-900">Log out <span aria-hidden="true">&rarr;</span></a> : <a href="/register" className="text-sm font-medium text-gray-700 hover:text-gray-800">Sign up</a>}  
    </div>
  </nav>
 ...
 <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
   <div className="flex items-center justify-between">
     ...
     <button onClick={closeNavHandler} type="button" className="-m-2.5 rounded-md p-2.5 text-gray-700">
   ...
   <div className="mt-6 flow-root">
     <div className="-my-6 divide-y divide-gray-500/10">
       <div className="space-y-2 py-6">
         ...
         { currentUser?.id && <Link to={`/profile/${currentUser.id}`} className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"> Account </Link> }
      
       </div>
       <div className="py-6">
          {currentUser? <a href="/logout" className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Log out</a> : <a href="/login" className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Sign in</a> }
       </div>
     </div>
   </div>
 </div>
